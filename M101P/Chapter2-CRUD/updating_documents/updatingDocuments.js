...
// Update One (.updateOne) with Increment ($inc) functionality
db.movieDetails.updateOne({title: "The Martian"}, {$inc: {"tomato.reviews": 3, "tomato.userReviews": 25}})

// Update One (.updateOne) with Adding to the end of an Array ($push) functionality)
...
// Update One (.updateOne) with Adding to the end of an Array ($push) multiple items ($each) functionality
db.movieDetails.updateOne({title: "The Martian"},
                          {$push: {reviews:
                                    {$each: [
                                        {rating: 0.5,
...
// Update One (.updateOne) with Push ($push), Each ($each), Postion ($position), and Slice ($slice) functionality
db.movieDetails.updateOne({title: "The Martian" },
                          {$push: {reviews:
                                    {$each: [
                                        {rating: 0.5,
...
// Update One (.updateOne) with Upsert (upsert) and Set ($set) functionality
